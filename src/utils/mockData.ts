...
export var MOCK_DROPS: Drop[] = [
  ...
  // ─── Music Drops ─────────────────────────────────────────────────────────
  {
    ...
    message: "Zostawiłem tu coś co słyszałem idąc przez Old Town o 3 w nocy. Jeśli tu doszedłeś — play i posiedź chwilę.",
    isClaimed: false,
    finderReward: 0.05,
    category: "lore",
  ...
  {
    id: "drop-music-2",
    location: { lat: 52.2195, lng: 21.0211 },
    message: "Ten utwór to moja praca z ostatnich 6 miesięcy. Wrzucam go tutaj za darmo — bo muzyka powinna być wolna. Audius FTW.",
    isClaimed: false,
    finderReward: 0,
    category: "secret",
    createdBy: "@phantom_producer",
    createdAt: "2026-02-23",
  ...
  },
  {
    ...
    message: "Muzyczny skarb przy Ogrodzie Saskim. Ktoś tu tańczył sam o świcie. Zostaw reakcję jeśli czujesz.",
    isClaimed: false,
    finderReward: 0.08,
    category: "ritual",
    createdBy: "@dawn_lich",
  ...
  },
  {
    ...
    message: "Soundtrack dla tych co chodzą po mieście z głową w chmurach. Warszawa nocą ma swoją częstotliwość.",
    isClaimed: false,
    finderReward: 0.12,
    category: "lore",
    ...
    createdAt: "2026-02-22",
    audiusTrackId: "987654321",
    audiusTrackName: "Warsaw Frequency",
